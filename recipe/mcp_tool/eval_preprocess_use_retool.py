...
if __name__ == "__main__":
    ...
    tools_config_file = "../retool/sandbox_fusion_tool_config.yaml"
    ...
    for tool_item in tools_config["tools"]:
        ...
        tool_schema = OmegaConf.to_container(tool_item["tool_schema"])
        # 将转换后的字典添加到列表中
...
"""
    ...
    math_data.to_parquet('/workspace/verl/data/eval/eval_data_retool.parquet')
