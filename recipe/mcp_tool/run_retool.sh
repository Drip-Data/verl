...
data_path=$path_prefix/data/eval/eval_data_retool.parquet
save_path=$path_prefix/data/eval/Qwn2.5_3b_Instruct_sft_tool_use_gen_test_retool.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path=$path_prefix/verl/recipe/mcp_tool/mcp_tool.py \
    ...
    trainer.project_name='mcp_tool_framework_test' \
    trainer.experiment_name='retool_test'
